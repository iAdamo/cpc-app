...
// companies
  const data = [
    {
      ...
      profilePicture:
        ...
        providerDescription: "Expert plumbing services for residential and commercial needs.",
      rating: 4.8,
      reviews: 120,
    ...
    },
    {
      ...
      profilePicture:
        "https://randomuser.me/api/portraits",
        providerDescription: "Quality painting services for interiors and exteriors.",
      rating: 4.5,
      reviews: 60,
      location: "Phoenix, AZ",
      category: "Painting",
    ...
    },
    {
      ...
      profilePicture:
        "https://randomuser.me/api/portraits",
        providerDescription: "Reliable moving services for local and long-distance moves.",
      rating: 4.6,
      reviews: 70,
    ...
    },
    {
      ...
      profilePicture:
        "https://randomuser.me/api/portraits",
        providerDescription: "Effective pest control solutions for homes and businesses.",
      rating: 4.7,
      reviews: 85,
    ...
    },
    {
      ...
      profilePicture:
        "https://randomuser.me/api/portraits",
        providerDescription: "Trusted appliance repair services for all major brands.",
      rating: 4.5,
      reviews: 55,
  ...
  const { displayView, } = useGlobalStore();
  const view = displayView === "Grid" ? "flex-row flex-wrap justify-between" : "flex flex-col";
  return (
